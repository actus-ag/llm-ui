...
describe("findCompleteCsvBlock", () => {
  const testCases: TestCase[] = [
    ...
    },
    {
      ...
      options: { type: "t" },
      expected: {
        startIndex: "⦅z,a,b,c⦆".length,
        endIndex: "⦅z,a,b,c⦆⦅t,a,b,c⦆".length,
        outputRaw: "⦅t,a,b,c⦆",
      },
    },
    {
